...
/*	if 	(DeQuien=="VIYQDHWIAA"){
	...
	var NOFEDXHMLS=(( YMHIHSNADE.world.width-AQONVWHHFT-((COIVBWRMCC*6)) - (YAJVUBPNNW*5)  +  COIVBWRMCC )    /2)+      (5 *(COIVBWRMCC+ YAJVUBPNNW))+COIVBWRMCC-(PJRPWGXEYM/2)+COIVBWRMCC;
	...
	var GHTWROCHVV=YMHIHSNADE.world.height-(AltoCarta*2)-(YAJVUBPNNW/2);
...
XIYTYOBTYD=function()
{
	...
	posX_U=(( YMHIHSNADE.world.width-AQONVWHHFT-((COIVBWRMCC*6)) - (YAJVUBPNNW*5)  +  COIVBWRMCC )/2)+ (4 *(COIVBWRMCC));
	posY_U=PXEBTYBHGS-( (COIVBWRMCC/2))-15;
	NXXLHVGDFY=0;
