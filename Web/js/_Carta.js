...
//vFormulaAjuste=-(COIVBWRMCC+YAJVUBPNNW)
	...
	ETAUVLWEYR.push(new HMNHQKBORK("U_5",0,NOFEDXHMLS,GHTWROCHVV)); //2.0.8054
...
function XIYTYOBTYD()
{
	//2.0.8054 sumo 40 a las X y 10 a las y para los cuenta palos
	
	VUFCMULFSR=(( YMHIHSNADE.world.width-AQONVWHHFT-((COIVBWRMCC*6)) - (YAJVUBPNNW*5)  +  COIVBWRMCC )/2)+ (4 *((COIVBWRMCC)))+50;
	QTQIWVWEOI=PXEBTYBHGS+( (COIVBWRMCC))-(COIVBWRMCC/5)-25+10;
	DDONCKKEVJ=0;
		
	GHGYTYYGNN=(( YMHIHSNADE.world.width-AQONVWHHFT-((COIVBWRMCC*6)) - (YAJVUBPNNW*5)  +  COIVBWRMCC )/2)+ (4 *(COIVBWRMCC))+50;
	HJGJWOCUMN=PXEBTYBHGS-( (COIVBWRMCC/2))-15+10;
	NXXLHVGDFY=0;

	IXWMVXRIVW=(( YMHIHSNADE.world.width-AQONVWHHFT-((COIVBWRMCC*6)) - (YAJVUBPNNW*5)  +  COIVBWRMCC )/2)+ (4 *(COIVBWRMCC))-(COIVBWRMCC)+(COIVBWRMCC/5)+50;
	QFPBRSSRCY=PXEBTYBHGS-10+10;//+( 1*(COIVBWRMCC+ YAJVUBPNNW));
	MALHKNCITQ=-90;
	//sprite.angle

	HCTVQVJJIB=(( YMHIHSNADE.world.width-AQONVWHHFT-((COIVBWRMCC*6)) - (YAJVUBPNNW*5)  +  COIVBWRMCC )/2)+ (5 *((COIVBWRMCC)))-(COIVBWRMCC/5)+50;
	IWGTWFENXM=PXEBTYBHGS-10+10;//+( 1*(COIVBWRMCC+ YAJVUBPNNW));
	WPVNAOXVJH=+90;
}
