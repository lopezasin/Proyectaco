...
HJDGSJHVWU=function(AWCCMSCOPO)
{
...
StorageSet=function(Consulta,HVCFEWNDRF)
{
	var QOWECQVXCM=false;
...
MostrarIrA=function(IrATexto,IrAWeb)
{
...
RespuestaIrA=function(JSKXXDPSDS)
{
	if (JSKXXDPSDS==true)
	{
		var a=document.getElementById("lblIrAWeb") ;
...
NBVNMWBJWW=function(UECHJBDMJL,UIWFVJSDMS,FTBVKLREAE)
{
...
KAUYGUKYSQ=function(VIYQDHWIAA)
{
	var EDLRWACYRF=[];
	var GEFUYWBVWG=[];
...
KKJJKHAJHK=function(UYWIUFCHJS,Sala)
{
	//NGHJWGJHWG(); //1.0.8
...
setEventHandlers = function () { //ESTE
 ...
 /*  socket.on('KJHKHEIEIE', function(data,callback)
  ...
  socket.on('GCOMOMYQBP', function(data,callback)
  {
	  ...
	  if (HMVFLEYPXM.length==0 && MNAGVJHWOW()==false && HGMNXSIAPV==true ) //(HGMNXSIAPV==true ||  MarcadorNuevo() )   ) 
	  {
...
FLKJPGBHIN=function(TXLWIIINGQ,idPartidaRecibida,RHOLNWBOXR)
{
	var i;
...
EliminaMensaje=function(ArrayPasar)
{
	var CKHBSQULIF=YMHIHSNADE.time.create(false);
...
LVEMXLIFKA=function(KJEWHVDJKS,New)
{
	var i;
	var u;
	var VEFCIYHBGC;
...
MCMWUEHUWH=function(ArrayDelaPropiaSalaClienteOrdenada,QuienReparteServer,TXLWIIINGQ)
{
	var i;
...
UIVHSKKJSH=function(JJHEHUIEGO)
{
	var i;
	var Existe=false;
...
BCVWETKAKG=function(JugadorQueReconecta,NombreDesconectado,posicionJugador,NuevoID,ArraySalaEnviar,QuienTomaControlServer,KJEWHVDJKS,TXLWIIINGQ)
{
	var LQPUBPQTJA;
	var i;
	var u;
...
BorrarBloqueo=function(TXLWIIINGQ)
{
	var i;
...
*/
 ...
 JHVKJDVHWW=function(Buscar1,Buscar2)
{
	var i;
	var u;
 ...
 OIQUIOCVKK=function(OIUIOWCHVW,Origen)
 {
  ...
  JHKJKHHJCC=function(TUTWNSAGSX){
...
XWGQYYRRQO = function(UHTPGPRUJA,SJVCMXWVVI,BBSGITWRQX,TXLWIIINGQ) {
 ...
 NOGEVUYFEW=function(UHTPGPRUJA,SJVCMXWVVI,turnoRecibido,SLGKDYQCAY,VMKDXVSQEY,PartidaRecibida,TXLWIIINGQ) {
