...
Inicia=function()
{
	...
	else
	{
			...
			var config = {  width: ancho,  height: alto, id:'koko',  renderer: Phaser.AUTO,  parent: 'gamer',  transparent: true,  antialias: true,  forceSingleUpdate:true, forceSetTimeOut: ForceSet }			
