	...
	if (vSonidoOn==true)
	{
		...
		if( (window.plugins && window.plugins.NativeAudio && lAudioTag==true ) || SO.toUpperCase()=="IOS" )
		{
			...
			case 'XKBVJQJRBV' :
				...
				if (LXGKVFJUFT<=5 && Reproducido==false)
				{
					window.plugins.NativeAudio.play('LSQGNFJBGH');
					Reproducido=true;
				}
				if (LXGKVFJUFT<=8 && Reproducido==false)
				{
					window.plugins.NativeAudio.play('SndPuntos');
					Reproducido=true;
				}	
				if (LXGKVFJUFT<=10 && Reproducido==false)
				{
			...
			case 'YURJWRGUNO' :
					...
					if (LXGKVFJUFT==1 && Reproducido==false)
					{
						window.plugins.NativeAudio.play('NEKUUPJKUV');
						Reproducido=true;
					}
					if (LXGKVFJUFT==2 && Reproducido==false)
					{
						window.plugins.NativeAudio.play('VPGBDEHDIT');
						Reproducido=true;
					}		
						
					if (LXGKVFJUFT==3  && Reproducido==false)
					{
			...
			case '_Grano' :
				...
				case '_Puntos' :
					...
					if (LXGKVFJUFT<=7 && Reproducido==false)
					{
						window.plugins.NativeAudio.play('SndPuntos');
						Reproducido=true;
					}			
			...
			if (OTGBWFDOND==true)
			{
				...
				else
				{
					var Reproducido=false;
					 ...
					 if (TTJFVWDTMG==YBVSVUGPJG[3].jugador && YBVSVUGPJG[3].WQCPJQWFPN==11 && LUCRWXJMDR<=5 && YBVSVUGPJG[3].SGCSHJVERI=="oros" && Reproducido==false && LUCRWXJMDR!=4)
					 {
						 EABXADHEVT("LMAYDDUATD");
						 Reproducido=true;
					 }	
					 
					 if (TTJFVWDTMG==YBVSVUGPJG[3].jugador && YBVSVUGPJG[3].WQCPJQWFPN==11 && LUCRWXJMDR<=5 && YBVSVUGPJG[3].SGCSHJVERI=="espadas" && Reproducido==false && LUCRWXJMDR!=4)
					 {
						 EABXADHEVT("XKBVJQJRBV");
						 Reproducido=true;
					 }		

					 if (TTJFVWDTMG==YBVSVUGPJG[3].jugador && YBVSVUGPJG[3].WQCPJQWFPN>=10 &&  LJKAEXAOJE<=20  &&  LJKAEXAOJE>11 && LUCRWXJMDR<=5  && Reproducido==false && LUCRWXJMDR!=4 && EVAILWGGKX==false)
					 {
						 EABXADHEVT("_Puntos");
						 Reproducido=true;
					 }
					 
					 if (TTJFVWDTMG==YBVSVUGPJG[3].jugador && YBVSVUGPJG[3].WQCPJQWFPN<10 && LJKAEXAOJE<=14  && LUCRWXJMDR<=5  && Reproducido==false && LUCRWXJMDR!=4 && EVAILWGGKX==false)
					 {
						 EABXADHEVT("_Chatarrero");
						 Reproducido=true;
					 }			

					 if ( (TTJFVWDTMG==YBVSVUGPJG[0].jugador || TTJFVWDTMG==YBVSVUGPJG[2].jugador)  && YBVSVUGPJG[3].WQCPJQWFPN>=10 && LUCRWXJMDR>=6  && Reproducido==false && LUCRWXJMDR!=4)
					 {
						 EABXADHEVT("_Escupe");
						 Reproducido=true;
					 }						 
					...
					)
					{
					  ...
					  if (LUCRWXJMDR==3  && Reproducido==false)
					 {
						 EABXADHEVT("_Suerte");
						 Reproducido=true;
					 }		
			...
			//timerCalculaTurno.add(1500, function() { //No me gusta pero si quitaba el 1 y el 4 fallaba. Es como que no le daba tiempo
				...
				if (VDKOVQXHON.length>0)
				{
					...
					log(true,"REAL "+VDKOVQXHON[VDKOVQXHON.length-1].VVRCMEUNOJ+" "+ VDKOVQXHON[VDKOVQXHON.length-1].SGCSHJVERI)
					 ...
					 {
						 if ( VDKOVQXHON[0].WQCPJQWFPN>=10 &&  VDKOVQXHON[0].SGCSHJVERI!=TGTQPBEQFR && VDKOVQXHON[1].WQCPJQWFPN>=10 &&  VDKOVQXHON[1].SGCSHJVERI!=TGTQPBEQFR && LUCRWXJMDR<=4 && Reproducido==false)
						 {
					  ...
					  if ( VDKOVQXHON[VDKOVQXHON.length-1].WQCPJQWFPN==2 &&  VDKOVQXHON[VDKOVQXHON.length-1].SGCSHJVERI==TGTQPBEQFR && LUCRWXJMDR>=5 && Reproducido==false)
					  {
						  EABXADHEVT("_Faldas");
						  Reproducido=true;
					  }
