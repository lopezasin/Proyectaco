...
//console.log(this.cache.checkImageKey('publi'));
	...
	if( window.plugins && window.plugins.NativeAudio )
	{
		...
		LoadCordova('SndCremallera', 'assets/sounds/cremallera.mp3');
		LoadCordova('SndMonedas', 'assets/sounds/monedas.mp3');
		
		
	}
	//else
	//{
		this.load.audio('SndCremallera', ['assets/sounds/cremallera.ogg','assets/sounds/cremallera.mp3']);
		this.load.audio('SndMonedas', ['assets/sounds/monedas.ogg','assets/sounds/monedas.mp3']);
