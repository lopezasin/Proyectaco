...
Preload.prototype.preload = function() {
	...
	var preloadBar = this.add.image(this.world.centerX, this.world.centerY,
			"loading");
...
//	this.load.image('Estallido', 'assets/images/estallido_amarillo.png',true);	
//	this.load.image('Estallido_40', 'assets/images/estallido_turquesa.png',true);	
	...
	this.load.image('Copa', 'assets/images/copa.png',true);	
