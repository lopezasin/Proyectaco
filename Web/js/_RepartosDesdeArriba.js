Repartir_Desde_Arriba=function(){
	Repartir_Desde_Arriba_U1();
};

Repartir_Desde_Arriba_U1=function(){
	...
	tw1 = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		...
		tw1.onComplete.add(function(){ GrupoU.add(MazoU[MazoU.length-1].cartilla); Repartir_Desde_Arriba_U2(); } );
		tw1.start();
		Mazo.pop();
...
Repartir_Desde_Arriba_U2=function(){
	...
	tw2 = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		tw2.to( {x:posX
		,y:posY}, vVelocidadCartas, EfectoTween2);
		tw2.onComplete.add(function(){ GrupoU.add(MazoU[MazoU.length-1].cartilla); Repartir_Desde_Arriba_U3(); } );
		tw2.start();
		Mazo.pop();
};

Repartir_Desde_Arriba_U3=function(){
	...
	tw3 = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		tw3.to( {x:posX
		,y:posY}, vVelocidadCartas, EfectoTween2);		
		tw3.onComplete.add(function(){ GrupoU.add(MazoU[MazoU.length-1].cartilla); Repartir_Desde_Arriba_L1(); } );
		tw3.start();
		Mazo.pop();
};
...
Repartir_Desde_Arriba_L1=function(){
	...
	tw4 = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		...
		tw4.onComplete.add(function(){ GrupoL.add(MazoL[MazoL.length-1].cartilla); Repartir_Desde_Arriba_L2(); } );
		tw4.start();
		Mazo.pop();
};


Repartir_Desde_Arriba_L2=function(){
	...
	twEsp7 = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		...
		, vVelocidadCartas, EfectoTween2);
		twEsp7.onComplete.add(function(){ GrupoL.add(MazoL[MazoL.length-1].cartilla); Repartir_Desde_Arriba_L3(); } );
		twEsp7.start();
		Mazo.pop();
};


Repartir_Desde_Arriba_L3=function(){
	...
	twReu = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		...
		, vVelocidadCartas, EfectoTween2);
		twReu.onComplete.add(function(){ GrupoL.add(MazoL[MazoL.length-1].cartilla); Repartir_Desde_Arriba_D1(); } );
		twReu.start();
		Mazo.pop();
};
...
Repartir_Desde_Arriba_D1=function(){
	...
	twRec1 = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		twRec1.to( {x:posX
		,y:posY}, vVelocidadCartas, EfectoTween2);
		twRec1.onComplete.add(function(){ GrupoD.add(MazoD[MazoD.length-1].cartilla); Repartir_Desde_Arriba_D2(); } );
		twRec1.start();
...
Repartir_Desde_Arriba_D2=function(){
	...
	twRec2 = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		twRec2.to( {x:posX
		,y:posY}, vVelocidadCartas, EfectoTween2);
		twRec2.onComplete.add(function(){ GrupoD.add(MazoD[MazoD.length-1].cartilla); Repartir_Desde_Arriba_D3(); } );
		twRec2.start();
		game_objeto.add.tween(Mazo[Mazo.length-1].cartilla.scale).to( {x:vEscaladoCarta,y:vEscaladoCarta}, vVelocidadCartas, EfectoTween2,true);
		Mazo.pop();
};

Repartir_Desde_Arriba_D3=function(){
	...
	twRec3 = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		twRec3.to( {x:posX
		,y:posY}, vVelocidadCartas, EfectoTween2);		
		twRec3.onComplete.add(function(){ GrupoD.add(MazoD[MazoD.length-1].cartilla); Repartir_Desde_Arriba_R1(); } );
		twRec3.start();
		game_objeto.add.tween(Mazo[Mazo.length-1].cartilla.scale).to( {x:vEscaladoCarta,y:vEscaladoCarta}, vVelocidadCartas, EfectoTween2,true);
		Mazo.pop();
};
...
Repartir_Desde_Arriba_R1=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		...
		, vVelocidadCartas, EfectoTween2);
		s.onComplete.add(function(){ GrupoR.add(MazoR[MazoR.length-1].cartilla); Repartir_Desde_Arriba_R2(); } );
		s.start();		
		Mazo.pop();
};


Repartir_Desde_Arriba_R2=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		...
		, vVelocidadCartas, EfectoTween2);
		s.onComplete.add(function(){ GrupoR.add(MazoR[MazoR.length-1].cartilla); Repartir_Desde_Arriba_R3(); } );
		s.start();
		Mazo.pop();
};


Repartir_Desde_Arriba_R3=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		...
		, vVelocidadCartas, EfectoTween2);
		s.onComplete.add(function(){ GrupoR.add(MazoR[MazoR.length-1].cartilla); Repartir_Desde_Arriba_U4(); } );
		s.start();
		Mazo.pop();
};
...
Repartir_Desde_Arriba_U4=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		s.to( {x:posX
		,y:posY}, vVelocidadCartas, EfectoTween2);
		s.onComplete.add(function(){ GrupoU.add(MazoU[MazoU.length-1].cartilla); Repartir_Desde_Arriba_U5(); } );
		s.start();
		Mazo.pop();
...
Repartir_Desde_Arriba_U5=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		s.to( {x:posX
		,y:posY}, vVelocidadCartas, EfectoTween2);
		s.onComplete.add(function(){ GrupoU.add(MazoU[MazoU.length-1].cartilla); Repartir_Desde_Arriba_U6(); } );
		s.start();
		Mazo.pop();
};

Repartir_Desde_Arriba_U6=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		s.to( {x:posX
		,y:posY}, vVelocidadCartas, EfectoTween2);		
		s.onComplete.add(function(){ GrupoU.add(MazoU[MazoU.length-1].cartilla); Repartir_Desde_Arriba_L4(); } );
		s.start();
		Mazo.pop();
};
...
Repartir_Desde_Arriba_L4=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		...
		, vVelocidadCartas, EfectoTween2);
		s.onComplete.add(function(){ GrupoL.add(MazoL[MazoL.length-1].cartilla); Repartir_Desde_Arriba_L5(); } );
		s.start();
		Mazo.pop();
};


Repartir_Desde_Arriba_L5=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		...
		, vVelocidadCartas, EfectoTween2);
		s.onComplete.add(function(){ GrupoL.add(MazoL[MazoL.length-1].cartilla); Repartir_Desde_Arriba_L6(); } );
		s.start();
		Mazo.pop();
};


Repartir_Desde_Arriba_L6=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		...
		, vVelocidadCartas, EfectoTween2);
		s.onComplete.add(function(){ GrupoL.add(MazoL[MazoL.length-1].cartilla); Repartir_Desde_Arriba_D4(); } );
		s.start();
		Mazo.pop();
};
...
Repartir_Desde_Arriba_D4=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		s.to( {x:posX
		,y:posY}, vVelocidadCartas, EfectoTween2);
		s.onComplete.add(function(){ GrupoD.add(MazoD[MazoD.length-1].cartilla); Repartir_Desde_Arriba_D5(); } );
		s.start();
		game_objeto.add.tween(Mazo[Mazo.length-1].cartilla.scale).to( {x:vEscaladoCarta,y:vEscaladoCarta}, vVelocidadCartas, EfectoTween2,true);
		Mazo.pop();
...
Repartir_Desde_Arriba_D5=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		s.to( {x:posX
		,y:posY}, vVelocidadCartas, EfectoTween2);
		s.onComplete.add(function(){ GrupoD.add(MazoD[MazoD.length-1].cartilla); Repartir_Desde_Arriba_D6(); } );
		s.start();
		game_objeto.add.tween(Mazo[Mazo.length-1].cartilla.scale).to( {x:vEscaladoCarta,y:vEscaladoCarta}, vVelocidadCartas, EfectoTween2,true);
		Mazo.pop();
};

Repartir_Desde_Arriba_D6=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		s.to( {x:posX
		,y:posY}, vVelocidadCartas, EfectoTween2);		
		s.onComplete.add(function(){ GrupoD.add(MazoD[MazoD.length-1].cartilla); Repartir_Desde_Arriba_R4(); } );
		s.start();
		game_objeto.add.tween(Mazo[Mazo.length-1].cartilla.scale).to( {x:vEscaladoCarta,y:vEscaladoCarta}, vVelocidadCartas, EfectoTween2,true);
		Mazo.pop();
};
...
Repartir_Desde_Arriba_R4=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		...
		, vVelocidadCartas, EfectoTween2);
		s.onComplete.add(function(){ GrupoR.add(MazoR[MazoR.length-1].cartilla); Repartir_Desde_Arriba_R5(); } );
		s.start();
		Mazo.pop();
};


Repartir_Desde_Arriba_R5=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		...
		, vVelocidadCartas, EfectoTween2);
		s.onComplete.add(function(){ GrupoR.add(MazoR[MazoR.length-1].cartilla); Repartir_Desde_Arriba_R6(); } );
		s.start();
		Mazo.pop();
};


Repartir_Desde_Arriba_R6=function(){
	...
	var s = game_objeto.add.tween(Mazo[Mazo.length-1].cartilla);
		...
		, vVelocidadCartas, EfectoTween2);
		s.onComplete.add(function(){ GrupoR.add(MazoR[MazoR.length-1].cartilla); SacaTriunfo(); } );		
		s.start();
		Mazo.pop();
